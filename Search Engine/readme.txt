...
Used JDBC (Java Database Connectivity) to crreate an SSH tunnel to the MariaDB database server using JDBC to store relevant data into a database, such as searrch history, from the search engine
